...
import { Copy, PlusSquare, Trash2, FileJson, AlertCircle } from "lucide-react";
        ...
        <Card className="flex flex-col border-none shadow-xl glass-panel relative overflow-visible">
          ...
          <Card.Content className="flex-1 p-0 flex flex-col">
            <TextArea
              ...
              placeholder={
                input === "" ? "Paste your raw JSON payload here..." : undefined
              }
              value={input}
        ...
        <Card className="flex flex-col border-none shadow-xl glass-panel relative overflow-visible">
          ...
          <Card.Content className="flex-1 p-0 flex flex-col">
            <TextArea
              ...
              value={output}
              placeholder="Beautifully formatted JSON will appear here..."
            />
          </Card.Content>
        </Card>
      </div>
